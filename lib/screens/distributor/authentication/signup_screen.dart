...
class DistributorSignupScreen extends StatefulWidget {
  const DistributorSignupScreen({Key? key}) : super(key: key);

  @override
  _DistributorSignupScreenState createState() =>
      _DistributorSignupScreenState();
}

class _DistributorSignupScreenState extends State<DistributorSignupScreen> {
                ...
                child: ListView(
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      decoration: InputDecoration(
                        labelText: S.of(context).crops_you_sell,
                      ),
                      validator: (value) {
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          ...
                          bool status =
                              await DistributorService.saveDistributor(
                            Distributor(
                          ...
                          if (status) {
                            DistributorService.sendOtp(
                                '+251${_phoneController.text}', context, false);
                          } else {
                            setState(() {
                              loading = false;
                            });
