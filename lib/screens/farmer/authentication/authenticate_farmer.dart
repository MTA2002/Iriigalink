...
class AuthenticateFarmer extends StatelessWidget {
  const AuthenticateFarmer({super.key});
            ...
            children: [
              ...
              Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(8),
                  child: const Image(
                    image: AssetImage('images/auth farmer 2.png'),
                  ),
                ),
              ),
              const SizedBox(
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.of(context).pushNamed('/sign_up_farmer');
                },
                child: Text(
