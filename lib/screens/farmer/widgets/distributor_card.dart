...
class DistributorCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.of(context).pushNamed('/dist_detail', arguments: distributor);
      },
      child: Card(
        elevation: 1,
        child: Container(
                      ...
                      Positioned(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            textHeader(
                              "${S.of(context).experience}: ${distributor.experience} ${S.of(context).years}",
                            ),
                          ],
                        ),
                      ),
